...
**トーナメント** — 最終到達ステージのポイントのみ (排他・累積しない)
...
**例:**
- フランス: GL 3勝 → 優勝 = (3,000×3) + 100,000 = **109,000pt**
- イングランド: GL 2勝1敗 → ベスト16敗退 = (3,000×2 - 3,000×1) + 20,000 = **23,000pt**
- ベルギー: GL 1勝2敗 → GL敗退 = (3,000×1 - 3,000×2) = **-3,000pt**
